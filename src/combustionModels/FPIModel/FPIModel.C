...
FPIModel<ReactionThermo>::FPIModel
(
...
//template<class CombThermoType>
template<class ReactionThermo>
hashedWordList FPIModel<ReactionThermo>::tables()
{
...
//template<class CombThermoType>
template<class ReactionThermo>
word FPIModel<ReactionThermo>::Lambda_table()
{
...
//template<class CombThermoType>
template<class ReactionThermo>
void FPIModel<ReactionThermo>::correct()
{
...
//template<class CombThermoType>
template<class ReactionThermo>
Switch FPIModel<ReactionThermo>::correctDensity()
{
	return true;
}
...
FPIModel<ReactionThermo>::Sh() const
{
...
template<class ReactionThermo>
Foam::tmp<Foam::volScalarField>
FPIModel<ReactionThermo>::Qdot() const
{
...
//template<class CombThermoType>
template<class ReactionThermo>
bool FPIModel<ReactionThermo>::read()
{
